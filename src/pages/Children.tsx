                  ...
                  <div id="print-area">
                    ...
                    <div className="mb-6 text-sm print-only">
                      ...
                      <ol className="list-decimal pl-5 space-y-1">
                        <li>
                          This record is generated by the CUB application as a PDF export of an in-app vault record.
                        </li>
                        <li>
                          Timestamps and dates reflect the system time recorded by the application services at the time of saving or updating.
                        </li>
                        <li>
                        ...
                        <li>
                          Edits and deletions (where applicable) are reflected in the saved record as of the export date.
                        </li>
                        <li>
                          Supporting documents are listed below and may include external file links where available.
                        </li>
                      </ol>
                    </div>
                    {/* Basic Info */}
