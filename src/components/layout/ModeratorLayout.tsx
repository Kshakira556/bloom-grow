// ModeratorLayout
// Used ONLY by mediators/moderators
...
export function ModeratorLayout({ children }: ModeratorLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Mobile layout (strictly mobile-only) */}
      <div className="md:hidden">
        <header className="h-16 bg-card border-b border-border flex items-center justify-between px-4">
          ...
          <div className="w-9 h-9 rounded-full bg-cub-coral-light flex items-center justify-center">
            <span className="font-display font-bold text-cub-coral text-xs">{initials}</span>
          </div>
        </header>
        ...
        {mobileMenuOpen && (
          <>
            ...
            />
            <aside className="fixed top-0 left-0 h-full w-72 bg-card border-r border-border z-50 flex flex-col">
